  ...
  return (
    <div style={{ display: 'flex', height: '100vh' }}>
      ...
      <main style={{ flex: 1, display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' }}>
        <header style={{ padding: '20px 24px 16px', display: 'flex', flexDirection: 'column', gap: 12 }}>
          <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
            ...
            <h1 style={{ fontSize: 24, fontWeight: 800, letterSpacing: '-0.02em', whiteSpace: 'nowrap' }}>
              Pokédex
              {selectedGeneration && <span style={{ color: 'rgba(255,255,255,0.3)', fontWeight: 400, margin: '0 4px' }}>·</span>}
              {selectedGeneration && <span style={{ color: 'rgba(255,255,255,0.5)', fontWeight: 600, fontSize: 18 }}>{REGION_NAMES[selectedGeneration]}</span>}
            </h1>
        ...
        <div style={{
          ...
          display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: 16, alignContent: 'start',
        }}>
          {isLoading
          ...
          {!isLoading && pokemons.length === 0 && (
            <div style={{ gridColumn: '1 / -1', textAlign: 'center', padding: 40, color: 'rgba(255,255,255,0.6)', fontSize: 14 }}>
